import { body } from "express-validator"; //um die validatoren zu überprüfen, verwenden wir den body
...
const registerValidator = () => {
  return [
    ...
    body("email")
      ...
      //cheken um das email vorher vorhanden ist
    ...
    //Mindestens ein Sonderzeichen,Mindestens ein kleinbuchstabe ,Mindestens ein Grossbuchstabe,Mindestens ein Zahl
      .matches(/(?=.*[0-9])(?=.*[!@#$%^&*])(?=.*[a-zA-Z])/)
      .withMessage(
